...
export const RepositoryOwner = () => {
    ...
    return (
        <div className="w-full bg-gray-200 rounded-xl p-2 shadow-lg">
            <a href={itemPage?.node?.owner?.url} target="_blank" rel="noopener noreferrer" className="w-max flex flex-row items-center justify-start gap-2 text-gray-900 hover:text-white">
